package agoraa.app.forms_back.resources.resources.controller
...
import agoraa.app.forms_back.resources.resources.service.ResourceService
...
class ResourceController(private val resourceService: ResourceService) {
    ...
    fun patchResource(
        @AuthenticationPrincipal customUserDetails: CustomUserDetails,
        @PathVariable id: Long,
        @RequestBody request: ResourcePatchRequest
    ): ResponseEntity<Any> {
        return ResponseEntity.status(HttpStatus.OK).body(
