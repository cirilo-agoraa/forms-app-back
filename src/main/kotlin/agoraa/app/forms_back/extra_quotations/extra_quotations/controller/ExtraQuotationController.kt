package agoraa.app.forms_back.extra_quotations.extra_quotations.controller
...
import agoraa.app.forms_back.extra_quotations.extra_quotations.service.ExtraQuotationService
...
class ExtraQuotationController(private val extraQuotationService: ExtraQuotationService) {
    ...
    fun createExtraQuotation(
        @AuthenticationPrincipal customUserDetails: CustomUserDetails,
        @Valid @RequestBody request: ExtraQuotationRequest,
    ...
    fun editExtraQuotation(
        @AuthenticationPrincipal customUserDetails: CustomUserDetails,
        @PathVariable id: Long,
        @RequestBody request: ExtraQuotationRequest
    ): ResponseEntity<Any> {
        return ResponseEntity.status(HttpStatus.OK).body(
    ...
    fun patchExtraQuotation(
        @AuthenticationPrincipal customUserDetails: CustomUserDetails,
        @PathVariable id: Long,
        @RequestBody request: ExtraQuotationPatchRequest
    ): ResponseEntity<Any> {
        return ResponseEntity.status(HttpStatus.OK).body(
            extraQuotationService.patch(
                customUserDetails,
                id,
                request
            )
